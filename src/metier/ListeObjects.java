/** **************************************** */
/* VOUS NE DEVEZ PAS MODIFIER CETTE CLASSE */
/** **************************************** */
package metier;
 ...
 * @version 1.2
 */
public class ListeObjects<Gen> {

    public static final int NO_POS = -1;
    /* Valeur de la position courante non définie */

    protected ArrayList<Gen> liste;
    /* Liste des Objects */
    private int pos = NO_POS;

    public ListeObjects(ArrayList liste) {
        this.liste = liste;
    }
     ...
     */
    public final boolean contains(Gen o) {
     ...
     * défini.
     */
    public final void add(Gen obj, int k) {
        if (k < 0 || k > liste.size()) {
            return;
        }
        liste.add(k, obj);
